      ...
      <div className="flex justify-between">
        <div>
          <Typography variant="h4" suppressHydrationWarning>
            Showing your last {shownleaverequests.length} Leave Requests
          </Typography>
          <Typography variant="lead">
            You can check the status of your recent leave requests and see your
        ...
        <div className="pt-4">
          ...
          >
            Apply for leave <ArrowRightIcon className="h-5 w-5 pb-0.5" />
          </Button>
        </div>
      </div>
      <div className="grid gap-4 grid-cols-4 grid-flow-row-dense my-8 w-5/6 ">
        {shownleaverequests.map((leave: any) => {
          return (
            <Card
              key=""
              color="indigo"
              ...
              <div className="flex">
                <div className="w-2/3">
                  <div className="my-2">
                    ...
                    <Typography variant="lead">{leave.start_date}</Typography>
                  </div>
                  <div className="my-2">
                    <Typography variant="small">To: </Typography>
                    <Typography variant="lead">{leave.end_date}</Typography>
                  </div>
                </div>
