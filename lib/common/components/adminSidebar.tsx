...
import {adminKeyTabMap, adminPathTabMap} from "@/lib/common/utils/adminSidebarConfig";
...
const AdminSidebar = () => {
    ...
    const getKeyFromPath = () => {
        ...
        if (adminPathTabMap.has(basePath)) {
            return adminPathTabMap.get(basePath)!.key;
        }
        return undefined;
    };
    ...
    const updateRoute = (key: string) => {
        if (!adminKeyTabMap.has(key)) return;
        const newTab = adminKeyTabMap.get(key)!;
                ...
                <ul>
                    <li className={`relative px-6 pb-3 pt-5 hover:cursor-pointer drop-shadow-md ${selected == "dashboard" ? "bg-indigo-50" : ""}`}>
                        ...
                        <a
                            ...
                            onClick={() => {
                                setSelected(adminPathTabMap.get("/dashboard")!.key)
                                updateRoute(adminPathTabMap.get("/dashboard")!.key)
                            }}
                        >
                            <svg
                                className="w-5 h-5"
                    ...
                    <li className={`relative px-6 pb-3 pt-5 hover:cursor-pointer drop-shadow-md ${selected == "checkIn" ? "bg-indigo-50" : ""}`}>
                        ...
                        <a
                            ...
                            onClick={() => {
                                setSelected(adminPathTabMap.get("/checkin")!.key)
                                updateRoute(adminPathTabMap.get("/checkin")!.key)
                            }}
                        >
                            <svg
                                className="w-5 h-5"
                            ...
                            <span className="ml-4">Manage Attendance</span>
                        </a>
                    </li>
                    <li className={`relative px-6 pb-3 pt-5 hover:cursor-pointer drop-shadow-md ${selected == "checkOut" ? "bg-indigo-50" : ""}`}>
                        ...
                        <a
                            ...
                            onClick={() => {
                                setSelected(adminPathTabMap.get("/checkout")!.key)
                                updateRoute(adminPathTabMap.get("/checkout")!.key)
                            }}
                        >
                            <svg
                                className="w-5 h-5"
                            ...
                            <span className="ml-4">Time Machine</span>
                        </a>
                    </li>
                    <li className={`relative px-6 pb-3 pt-5 hover:cursor-pointer drop-shadow-md ${selected == "leaveRequest" ? "bg-indigo-50" : ""}`}>
                        ...
                        <a
                            ...
                            onClick={() => {
                                setSelected(adminPathTabMap.get("/leave_request")!.key)
                                updateRoute(adminPathTabMap.get("/leave_request")!.key)
                            }}
                        >
                            <svg
                                className="w-5 h-5"
                            ...
                            <span className="ml-4">Manage Locations</span>
                        </a>
                    </li>
                </ul>
